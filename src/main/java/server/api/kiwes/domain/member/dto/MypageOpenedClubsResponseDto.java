...
@AllArgsConstructor
@Builder
public class MypageOpenedClubsResponseDto {
    private Long clubId;
    ...
    public static MypageOpenedClubsResponseDto of(ClubMember clubMember){
        ...
        return MypageOpenedClubsResponseDto.builder()
                .clubId(club.getId())
    ...
    public boolean equals(Object o) {
        ...
        MypageOpenedClubsResponseDto that = (MypageOpenedClubsResponseDto) o;
